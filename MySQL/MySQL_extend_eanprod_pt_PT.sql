########################################################
## MySQL_extend_eanprod_pt_PT.sql                v2.7 ##
...
## ar_SA,pt_PT,fr_FR,it_IT,pt_PT,tr_TR,cs_CZ,es_MX,   ##
...
DROP TABLE IF EXISTS activepropertylist_pt_PT;
CREATE TABLE activepropertylist_pt_PT
(
...
DROP TABLE IF EXISTS aliasregionlist_pt_PT;
CREATE TABLE aliasregionlist_pt_PT
(
...
CREATE INDEX idx_aliasregionlist_pt_PT_regionid ON aliasregionlist_pt_PT(RegionID);


## AreaAttractionsList - structure is the same as US version
DROP TABLE IF EXISTS areaattractionslist_pt_PT;
CREATE TABLE areaattractionslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS attributelist_pt_PT;
CREATE TABLE attributelist_pt_PT
(
...
DROP TABLE IF EXISTS countrylist_pt_PT;
CREATE TABLE countrylist_pt_PT
(
...
CREATE INDEX idx_countrylist_pt_PT_countryname ON countrylist_pt_PT(CountryName);
...
DROP TABLE IF EXISTS diningdescriptionlist_pt_PT;
CREATE TABLE diningdescriptionlist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS policydescriptionlist_pt_PT;
CREATE TABLE policydescriptionlist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertyattributelink_pt_PT;
CREATE TABLE propertyattributelink_pt_PT
(
	EANHotelID INT NOT NULL,
	AttributeID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertydescriptionlist_pt_PT;
CREATE TABLE propertydescriptionlist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertytypelist_pt_PT;
CREATE TABLE propertytypelist_pt_PT
(
...
DROP TABLE IF EXISTS recreationdescriptionlist_pt_PT;
CREATE TABLE recreationdescriptionlist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS regionlist_pt_PT;
CREATE TABLE regionlist_pt_PT
(
  RegionID INT NOT NULL,
  LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS spadescriptionlist_pt_PT;
CREATE TABLE spadescriptionlist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
	SpaDescription TEXT,
...
DROP TABLE IF EXISTS roomtypelist_pt_PT;
CREATE TABLE roomtypelist_pt_PT
(
	EANHotelID INT NOT NULL,
...
DROP TABLE IF EXISTS whattoexpectlist_pt_PT;
CREATE TABLE whattoexpectlist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
	WhatToExpect TEXT,
...
DROP TABLE IF EXISTS propertylocationlist_pt_PT;
CREATE TABLE propertylocationlist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertyamenitieslist_pt_PT;
CREATE TABLE propertyamenitieslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertyroomslist_pt_PT;
CREATE TABLE propertyroomslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertybusinessamenitieslist_pt_PT;
CREATE TABLE propertybusinessamenitieslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertynationalratingslist_pt_PT;
CREATE TABLE propertynationalratingslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertyfeeslist_pt_PT;
CREATE TABLE propertyfeeslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertymandatoryfeeslist_pt_PT;
CREATE TABLE propertymandatoryfeeslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS propertyrenovationslist_pt_PT;
CREATE TABLE propertyrenovationslist_pt_PT
(
	EANHotelID INT NOT NULL,
	LanguageCode VARCHAR(5),
...
DROP TABLE IF EXISTS activepropertybusinessmodel_pt_PT;
CREATE TABLE activepropertybusinessmodel_pt_PT 
(
  EANHotelID INT NOT NULL,
  LanguageCode VARCHAR(5),
  Name VARCHAR(70),
